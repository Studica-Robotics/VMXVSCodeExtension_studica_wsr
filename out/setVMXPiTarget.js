...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand('vmxpi-wsr.setVMXPiTarget', () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            vscode.window.showInformationMessage('Your project is now configured for a VMX WSR target');
        }
        catch (err) {
